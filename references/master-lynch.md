# David Lynch — charged ideas, coherent mystery, recurrence
...
Lynch discusses repeating the same material in different contexts so it carries a different feeling or reading the second time.

**Operational inference — S:** design a return as `A → experience → A′`. Preserve identity while changing context, stakes, or audience knowledge.

### Strange worlds still need rules — P

In the 1986 *Film Comment* interview, Lynch says even a strange story establishes rules; breaking them reads as dishonesty.
...
**Operational inference — S:** a breach has force only when the surface is readable enough to be breached. Avoid making every element ominous from the first moment.

### Rhythm has fast and slow areas — P

In an interview published by *AnOther*, Lynch compares flow in film and painting to relationships between fast and slow areas and stresses establishing a sense of place before going deep.
...
- Establish a readable surface through composition, light, space, or ordinary relation.
- Introduce one controlled anomaly with a causal, emotional, or associative job.
...
- What is the charged thing before we explain it?
- Which expectation must exist before the breach matters?
- What is the world's rule?
- What clue tells the audience the anomaly is meaningful?
- What can remain beautifully abstract without hiding a required fact?
- What should return, and what should be different when it does?

## Failure conditions

- “Lynch” becomes a synonym for surreal, dark, dreamlike, or unexplained.
- Random symbols have no rule or clue path.
- Ambiguity hides missing evidence or weak causality.
...
Stay secondary when the task requires exact procedural instruction, dense factual comparison, or immediate operational clarity with little room for unresolved interpretation.
